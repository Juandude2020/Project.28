class Tree
{
    constructor(x,y)
    {
        ...
        this.bottomBody=Bodies.rectangle(this.x, this.y, thisdustWidth, this.wallThickness,{isStatic:true})
        ...
        AudioWorkletNode.add(world, this.bottomBody)
    ...
    display()
    {
             var posBottom=this.bottomBody.position;push ()
